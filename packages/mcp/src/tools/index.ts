...
import {
  registerApprovePermissionRequestTool,
  registerApproveQueueCommandTool,
  registerAuthzTools,
  registerCancelQueueCommandTool,
  registerListActionQueueTool,
  registerListAuditEventsTool,
  registerListPermissionRequestsTool,
  registerListMyPermissionRequestsTool,
  registerReadEffectiveRightsTool,
  registerReadGrantAssignmentsTool,
  registerRejectPermissionRequestTool,
  registerRepoTools,
  registerRequestPermissionsTool,
} from "./admin_tools.js";
import { registerUploadCommandArtifactTool } from "./upload_command_artifact.js";
import type { RegisteredToolSpec } from "../types.js";

export function registerTools(server: McpServer, client: HecateApiClient): RegisteredToolSpec[] {
  return [
    ...
    registerListMyPermissionRequestsTool(server, client),
