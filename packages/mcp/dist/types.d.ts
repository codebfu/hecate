...
export type CommandStatus = "pending_approval" | "queued" | "dispatched" | "running" | "completed" | "failed" | "expired" | "cancelled";
...
export type AuthzProvenance = "operator" | "permission_request" | "import" | "seed";
